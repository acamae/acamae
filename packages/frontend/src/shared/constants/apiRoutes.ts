// Este archivo debe mantenerse sincronizado con packages/backend/src/shared/constants/apiRoutes.ts
// Las rutas aquí son relativas a la baseURL configurada en axiosService (process.env.REACT_APP_API_URL)
